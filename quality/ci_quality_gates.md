...
5. agent quality evidence governance through `scripts/check_agent_quality_evidence.py`, which
   ...
   `src/app/clients/lotus_analytics_performance_client.py`, and durable
...
9. duplicate-code clone count must not exceed 66, duplicated lines must not exceed 1,311, and
   duplicated percentage must not exceed 1.38%; stable source-pair/normalised-fragment
