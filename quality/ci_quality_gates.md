...
9. duplicate-code clone count must not exceed 76, duplicated lines must not exceed 1,501, and
   duplicated percentage must not exceed 1.59%; stable source-pair/normalised-fragment
