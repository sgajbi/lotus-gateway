...
9. duplicate-code clone count must not exceed 84, duplicated lines must not exceed 1,686, and
   duplicated percentage must not exceed 1.81%; stable source-pair/normalised-fragment
