...
9. duplicate-code clone count must not exceed 71, duplicated lines must not exceed 1,421, and
   duplicated percentage must not exceed 1.50%; stable source-pair/normalised-fragment
