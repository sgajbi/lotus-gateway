...
9. duplicate-code clone count must not exceed 70, duplicated lines must not exceed 1,388, and
   duplicated percentage must not exceed 1.47%; stable source-pair/normalised-fragment
