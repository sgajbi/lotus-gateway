...
5. agent quality evidence governance through `scripts/check_agent_quality_evidence.py`, which
   ...
   `src/app/clients/advise_proposal_client.py`, and durable scorecard/context
   guidance in sync,
6. `mypy` over `src`,
...
7. Quality Baseline and `make lint` now run the blocking agent quality evidence gate through
   ...
   `src/app/clients/advise_proposal_client.py` as the current evidence-selected
   329-line hotspot after DPM command-center client extraction.
