...
9. duplicate-code clone count must not exceed 85, duplicated lines must not exceed 1,705, and
   duplicated percentage must not exceed 1.90%; stable source-pair/normalised-fragment
