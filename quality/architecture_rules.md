...
1. `src/app/services/risk_workspace_drawdown.py` at 352 lines.
...
executable 352/49 ratchet, the current `src/app/services/risk_workspace_drawdown.py` hotspot, and
