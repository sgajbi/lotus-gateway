...
extraction, DPM portfolio-memory search query metadata extraction, and performance chart-point row
projection extraction. The current longest functions are `request_with_retry` and
