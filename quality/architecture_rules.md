...
1. `src/app/services/performance_workspace_service.py` at 437 lines,
2. `src/app/services/risk_workspace_attribution.py` at 432 lines,
3. `src/app/services/risk_workspace_rolling.py` at 432 lines,
4. `src/app/contracts/proposals.py` at 431 lines,
5. `src/app/services/advisor_brief_source.py` at 429 lines.
