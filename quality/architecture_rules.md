...
1. `src/app/services/risk_workspace_attribution.py` at 432 lines,
2. `src/app/services/risk_workspace_rolling.py` at 432 lines,
3. `src/app/contracts/proposals.py` at 431 lines,
4. `src/app/services/advisor_brief_source.py` at 429 lines,
5. `src/app/services/platform_capabilities_service.py` at 427 lines.
