...
1. `src/app/services/foundation_service.py` at 951 script-counted lines,
2. `src/app/contracts/performance_workspace.py` at 930 script-counted lines,
3. `src/app/clients/advise_client.py` at 909 script-counted lines,
4. `src/app/router_registry.py` at 868 script-counted lines,
5. `src/app/services/advisor_brief_service.py` at 861 script-counted lines.
