...
1. `src/app/services/proposal_service.py` at 324 lines as the
...
executable 324/49 ratchet, the current evidence-selected
`src/app/services/proposal_service.py` hotspot, and durable scorecard/context
