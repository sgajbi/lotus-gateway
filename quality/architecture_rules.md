...
1. `src/app/services/performance_workspace_horizon.py` at 441 lines,
2. `src/app/contracts/performance_attribution.py` at 440 lines,
3. `src/app/services/advisor_brief_service.py` at 438 lines,
4. `src/app/services/performance_workspace_service.py` at 437 lines,
5. `src/app/services/risk_workspace_rolling.py` at 432 lines.
