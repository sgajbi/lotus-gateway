...
1. `src/app/services/risk_workspace_attribution.py` at 408 lines,
2. `src/app/clients/advise_proposal_client.py` at 406 lines,
3. `src/app/contracts/proposal_lifecycle.py` at 405 lines,
4. `src/app/services/proposal_service.py` at 405 lines,
5. `src/app/services/platform_capabilities_normalization.py` at 404 lines.
