...
1. `src/app/contracts/portfolio_holdings.py` at 476 lines,
2. `src/app/services/performance_workspace_attribution.py` at 471 lines,
3. `src/app/contracts/domain_products.py` at 465 lines,
4. `src/app/services/portfolio_transaction_summary.py` at 462 lines,
5. `src/app/services/workspace_client_protocols.py` at 458 lines.
