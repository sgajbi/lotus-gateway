...
1. `src/app/services/workspace_client_protocols.py` at 329 lines as the
...
executable 329/49 ratchet, the current evidence-selected
`src/app/services/workspace_client_protocols.py` hotspot, and durable scorecard/context
