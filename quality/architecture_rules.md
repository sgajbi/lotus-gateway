...
1. `src/app/services/dpm_pm_operating_quality_service.py` at 383 lines,
2. `src/app/services/portfolio_workflow.py` at 381 lines,
3. `src/app/contracts/risk_workspace_examples.py` at 379 lines,
4. `src/app/services/upstream_envelope.py` at 378 lines.
...
executable 383/49 ratchet, the current
`src/app/services/dpm_pm_operating_quality_service.py` hotspot, and durable scorecard/context
