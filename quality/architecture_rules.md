...
1. `src/app/services/performance_workspace_service.py` at 354 lines.
...
executable 354/49 ratchet, the current `src/app/services/performance_workspace_service.py` hotspot, and durable
