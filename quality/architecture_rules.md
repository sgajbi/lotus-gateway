...
1. `src/app/services/portfolio_service.py` at 1,553 script-counted lines,
...
portfolio workspace payload and control-capability helpers. Performance workspace final response
