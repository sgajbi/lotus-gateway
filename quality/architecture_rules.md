...
1. `src/app/services/advisor_brief_workflow_pack.py` at 344 lines.
...
executable 344/49 ratchet, the current `src/app/services/advisor_brief_workflow_pack.py` hotspot, and
