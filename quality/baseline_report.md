...
description, tags, or at least one documented 4xx/5xx response. The first Spectral smoke found no
errors. Most remaining warnings are generated by the inherited `spectral:oas` baseline for missing
