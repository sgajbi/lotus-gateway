...
| ---: | ---: | --- | --- |
| 1 | 51 | `get_portfolio_readiness` | `src/app/services/portfolio_service.py` |
| 2 | 51 | `build_workspace_capabilities` | `src/app/services/performance_workspace_capabilities.py` |
| 3 | 51 | `apply_sandbox_changes` | `src/app/services/workbench_service.py` |
| 4 | 51 | `_load_portfolio_allocation_payloads` | `src/app/services/portfolio_service.py` |
| 5 | 51 | `_build_evidence_view` | `src/app/services/performance_workspace_service.py` |
| 6 | 50 | `parse_horizon_comparison_result` | `src/app/services/performance_workspace_horizon.py` |
| 7 | 50 | `merge_contribution_summary_views` | `src/app/services/performance_workspace_contribution.py` |
| 8 | 49 | `request_binary_with_retry` | `src/app/clients/http_resilience.py` |
| 9 | 49 | `map_drawdown_response` | `src/app/services/risk_workspace_drawdown.py` |
| 10 | 49 | `get_transaction_ledger` | `src/app/services/portfolio_service.py` |
...
5. Current focused branch: portfolio transaction-ledger tests passed with 4 selected tests.
6. Current focused branch: portfolio workspace tests passed with 7 selected tests.
7. Current focused branch: Lotus Core transaction client tests passed with 2 selected tests.
8. Current focused branch: foundation optional-upstream tests passed with 4 selected tests.
9. Current focused branch: archive document service tests passed with 8 tests.
10. Current focused branch: risk drawdown unit tests passed with 4 selected tests.
11. Current focused branch: risk drawdown router integration test passed with 1 selected test.
12. Current focused branch: performance workspace response tests passed with 5 selected tests.
13. Current focused branch: attribution-trend unit tests passed with 3 selected tests.
14. Current focused branch: attribution-trend router integration tests passed with 3 selected tests.
15. Current focused branch: benchmark catalog module tests passed with 8 tests.
16. Current focused branch: risk attribution module tests passed with 4 tests.
17. Current focused branch: risk attribution service tests passed with 5 selected tests.
18. Current focused branch: risk attribution router integration test passed with 1 selected test.
19. Current focused branch: portfolio insight service tests passed with 6 selected tests.
20. Current focused branch: portfolio insight service/router tests passed with 8 selected tests.
21. Current focused branch: current-position unit tests passed with 5 selected tests.
22. Current focused branch: current-position router tests passed with 2 selected tests.
23. Current focused branch: performance horizon comparison router tests passed with 3 selected tests.
24. Current focused branch: advisor brief service/router tests passed with 24 selected tests.
25. Current focused branch: risk concentration router test passed with 1 selected test.
26. Current focused branch: Workbench analytics tests passed with 7 selected tests.
27. Current focused branch: Workbench rebalance tests passed with 3 selected tests.
28. Current focused branch: portfolio readiness tests passed with 4 selected tests.
29. Latest merged PR-grade evidence: `make ci` passed with 207 integration tests on commit `b8f01c4`.
30. Latest merged PR-grade evidence: `make ci` passed with 1,176 coverage tests on commit `b8f01c4`.
31. Coverage: 93.36%.
32. `pip-audit`: no known vulnerabilities after the governed `PYSEC-2026-161` exception.
