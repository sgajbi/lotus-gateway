...
active-risk, and total-risk benchmark-exposure helpers. `portfolio_service.py` is now 2,621 lines,
and the repository longest-function baseline is now 82 lines. The remaining work is still substantial: large
