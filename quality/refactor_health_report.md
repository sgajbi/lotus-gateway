...
| --- | --- | --- |
| Branch hygiene | Healthy | Current Bank-Buyable metric-label contract branch was created from clean `main` after PR #378; final remote/local cleanup remains a post-merge gate |
| Unit/contract coverage | Healthy | Current Bank-Buyable metric-label contract branch `make check` passed with ruff, format check, monetary-float guard, refactor threshold gate, mypy over 472 source files, Workbench/OpenAPI contract smoke, and 1,079 unit/contract tests |
| Integration coverage | Healthy | Current Bank-Buyable metric-label contract branch `make ci` passed with 207 integration tests |
| Total coverage | Healthy | Current Bank-Buyable metric-label contract branch `make ci` passed with 1,286 coverage tests and 94.07% total coverage, above the 84% floor |
