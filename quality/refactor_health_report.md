...
| Modularity | Improving, incomplete | Longest-function baseline remains 49 lines; current branch moves Advisor Brief source narrative builders into a focused helper module while preserving the public source context builder. The largest current source-file hotspot is `src/app/clients/http_resilience.py` at 363 lines |
