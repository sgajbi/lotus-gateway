...
| Duplication | 3/5 | The pinned jscpd quality tool now measures 88 production clone findings, 1,767 duplicated lines, and 2.03% duplicated lines, with stable source-pair-plus-normalised-fragment fingerprints and a no-new-regression ratchet. Existing clones remain explicit debt; this slice does not pretend they are cleaned up. | Remove or consolidate reviewed production clones while preserving the ratchet |
