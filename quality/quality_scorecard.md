...
| API governance | 4/5 | Operation-level description, tag, and error-response gaps closed and contract-tested; Spectral/global tag warnings remain report-only | Triage Spectral warnings and decide explicit operation ID policy |
