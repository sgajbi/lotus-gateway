...
| Documentation | 4/5 | Baseline, scorecard, health report, observability docs, and operations wiki source record the metric-label contract gate added in the current Bank-Buyable metric-label slice | Keep wiki synced and add diagrams over time |
