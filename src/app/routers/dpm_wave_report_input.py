...
async def _get_wave_report_input(*, tenant_id: str, wave_id: str) -> DpmWaveGatewayResponse:
...
async def get_wave_report_input(
    ...
    return await _get_wave_report_input(tenant_id=tenant_id, wave_id=wave_id)
