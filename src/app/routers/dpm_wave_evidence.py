...
async def _get_wave_proof_pack_posture(*, tenant_id: str, wave_id: str) -> DpmWaveGatewayResponse:
...
async def get_wave_proof_pack_posture(
    ...
    return await _get_wave_proof_pack_posture(tenant_id=tenant_id, wave_id=wave_id)
