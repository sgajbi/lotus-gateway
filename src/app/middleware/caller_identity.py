...
propagates, and only the Core READ (query) client consumes it — never Core
writes, where a caller-selected fence would scope a mutation into another
tenant's partition: other
