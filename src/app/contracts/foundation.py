...
from app.contracts.foundation_catalog import (
    FoundationPortfolioCatalogItem as FoundationPortfolioCatalogItem,
)
from app.contracts.foundation_catalog import (
    FoundationPortfolioCatalogResponse as FoundationPortfolioCatalogResponse,
)
