...
from app.contracts.risk_mandate_comparison_examples import (
    CONCENTRATION_MANDATE_COMPARISON_EXAMPLE,
    SUMMARY_MANDATE_COMPARISON_EXAMPLE,
)
...
_RISK_SUMMARY_RESPONSE_EXAMPLE: dict[str, Any] = {
    ...
    "mandate_comparison": SUMMARY_MANDATE_COMPARISON_EXAMPLE,
    "supportability": [
        {
...
_RISK_CONCENTRATION_RESPONSE_EXAMPLE: dict[str, Any] = {
    ...
    "mandate_comparison": CONCENTRATION_MANDATE_COMPARISON_EXAMPLE,
    "supportability": [
        {
