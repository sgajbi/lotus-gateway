...
class AdviseClient:
    ...
    async def create_copilot_evidence_packet(
        self,
        body: dict[str, Any],
        correlation_id: str,
    ) -> tuple[int, dict[str, Any]]:
    ...
    async def get_copilot_supportability(
        self,
        correlation_id: str,
    ) -> tuple[int, dict[str, Any]]:
        return await self._get(
    ...
    async def list_proposal_version_copilot_runs(
        self,
        proposal_id: str,
        version_id: str,
        correlation_id: str,
        ...
        return await self._get(
            ...
            params={},
            headers=self._headers(correlation_id),
            operation="advise.advisory.copilot.proposal-version-runs",
        )
