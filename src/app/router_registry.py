...
from app.routers.ideas_ai_explanations import router as ideas_ai_explanations_router
...
IDEA_ROUTERS: RouterGroup = (
    ideas_router,
    ideas_actions_router,
    ideas_ai_explanations_router,
    ideas_presentation_router,
)
