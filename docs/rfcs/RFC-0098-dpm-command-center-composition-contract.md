...
14. Wave routes preserve manage-owned `wave_id`, lifecycle state, item states, reason codes,
   ...
   launch history, launch-package readiness, launch wave responses, supportability issues,
   source-owner remediation, replay posture, and the no-external-execution boundary.
15. Gateway does not calculate affected portfolios, classify source readiness, generate
   ...
   or claim external execution locally.
