...
| `lotus-advise` | proposal lifecycle, advisory workflow, reviewed narrative, report-request, delivery-posture, policy-pack, policy-evaluation, review-queue, sign-off, report-package, lineage, replay, event, AI-evidence, and advisor-cockpit `/advisory/cockpit/*` action/preparation-packet/snapshot/supportability/acknowledgement surfaces | proposal workflow, advisor-use narrative posture composition, suitability / best-interest policy posture composition, and advisor cockpit product-facing publication | advisory decision workflow, narrative review, source-hash continuity, policy-pack truth, policy-evaluation truth, supportability, degraded/blocked posture, maker-checker state, AI-evidence posture, report-package posture, advisor-cockpit action status, priority, owner role, reason codes, preparation-packet posture, evidence refs, lineage refs, acknowledgement state, and proposal delivery truth remain in `lotus-advise`; gateway must not generate narrative, evaluate policy rules, administer policy locally, infer supportability, override sign-off, infer client-ready publication, reconstruct cockpit or preparation semantics, render reports, archive documents, or recompute delivery truth |
