...
| `lotus-advise` | proposal lifecycle, advisory workflow, reviewed narrative, report-request, and delivery-posture surfaces | proposal workflow and advisor-use narrative posture composition | advisory decision workflow, narrative review, source-hash continuity, report-package posture, and proposal delivery truth remain in `lotus-advise`; gateway must not generate narrative, infer client-ready publication, render reports, archive documents, or recompute delivery truth |
