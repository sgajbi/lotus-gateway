...
1. proposal simulation, lifecycle, typed selected-proposal risk-and-impact evidence and
   implementation-status evidence, workflow, approval, lineage, replay, report request, delivery
