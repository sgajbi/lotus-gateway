...
aliases with multiple assignments are ambiguous and fail closed. Parameter rebindings are collected
across plain, destructured, augmented, loop, and named-expression targets; writes to trusted base
URL attributes also invalidate the transport exemption. The seven generic transport exemptions apply only to
