...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 480/49 refactor ratchet, the
   current `src/app/contracts/dpm_waves.py` hotspot, and durable scorecard/context
