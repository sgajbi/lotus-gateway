...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 476/49 refactor ratchet, the
   current `src/app/contracts/portfolio_holdings.py` hotspot, and durable scorecard/context
