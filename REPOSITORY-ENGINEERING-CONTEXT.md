...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 479/49 refactor ratchet, the
   current `src/app/services/risk_workspace_drawdown.py` and
   `src/app/services/dpm_wave_service.py` hotspots, and durable scorecard/context
