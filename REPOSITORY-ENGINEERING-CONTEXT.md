...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 330/49 refactor ratchet, the
   current evidence-selected `src/app/clients/dpm_client.py` hotspot, and durable
