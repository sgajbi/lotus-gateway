...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 342/49 refactor ratchet, the
   current `src/app/services/risk_workspace_rolling.py` hotspot, and durable
