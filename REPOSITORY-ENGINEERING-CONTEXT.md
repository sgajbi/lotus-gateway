...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 319/49 refactor ratchet, the
   current evidence-selected `src/app/contracts/portfolio_workspace.py` hotspot, and durable
