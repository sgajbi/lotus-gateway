...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 361/49 refactor ratchet, the
   current `src/app/contracts/performance_attribution.py` hotspot, and durable
