...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 335/49 refactor ratchet, the
   current evidence-selected `src/app/services/performance_workspace_capabilities.py` hotspot, and durable
