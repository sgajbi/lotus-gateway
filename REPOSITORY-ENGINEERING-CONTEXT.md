...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 499/49 refactor ratchet, the
   current `src/app/contracts/dpm_command_center.py` hotspot, and durable scorecard/context
