...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 471/49 refactor ratchet, the
   current `src/app/services/performance_workspace_attribution.py` hotspot, and durable scorecard/context
