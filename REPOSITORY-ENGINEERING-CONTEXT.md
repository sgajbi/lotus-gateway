...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 360/49 refactor ratchet, the
   current `src/app/clients/reporting_client.py` hotspot, and durable
