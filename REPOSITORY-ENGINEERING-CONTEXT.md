...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 344/49 refactor ratchet, the
   current `src/app/services/performance_workspace_evidence_response.py` hotspot, and durable
