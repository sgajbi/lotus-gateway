...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 411/49 refactor ratchet, the
   current `src/app/services/dpm_wave_ai_handoff.py` hotspot, and durable
