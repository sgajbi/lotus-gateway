...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 438/49 refactor ratchet, the
   current `src/app/services/advisor_brief_service.py` hotspot, and durable scorecard/context guidance
