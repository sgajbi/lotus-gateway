...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 385/49 refactor ratchet, the
   current `src/app/observability/analytics_ui.py` hotspot, and durable
