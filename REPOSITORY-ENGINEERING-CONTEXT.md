...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 356/49 refactor ratchet, the
   current `src/app/services/dpm_pm_operating_quality_service.py` hotspot, and durable
