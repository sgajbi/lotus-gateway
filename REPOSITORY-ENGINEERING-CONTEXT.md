...
5. agent quality evidence governance is part of `make lint` through
   `scripts/check_agent_quality_evidence.py`; it keeps the executable 378/49 refactor ratchet, the
   current `src/app/services/upstream_envelope.py` hotspot, and durable
