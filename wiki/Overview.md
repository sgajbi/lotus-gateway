...
| Ideas | Advisor opportunity review and evidence drill-down | Active read-only Gateway publication for advisor review queue with entitlement-scope forwarding and source-safe candidate detail; no local idea generation, ranking, enrichment, or promotion | `lotus-idea` |
