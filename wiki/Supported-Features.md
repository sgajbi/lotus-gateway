...
`transaction_date` is the Core-owned transaction event timestamp used for event-date filtering and
...
`PERFORMANCE_DETAILS_CURRENCY_NOT_APPLIED_BASE`. Gateway anchors the summary window to the requested
