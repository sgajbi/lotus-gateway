...
- current enterprise-hardening evidence records `src/app/contracts/workbench.py` as the largest
  residual source file at 794 script-counted lines after portfolio workflow orchestration moved
  into `src/app/services/portfolio_workflow_service.py`, reducing
  `src/app/services/portfolio_service.py` from 811 to 768 script-counted lines; the repository
