...
| Future agent | What quality ceiling must not regress? | Agent quality evidence: `324/49`, current hotspot `src/app/services/proposal_service.py` |
...
324/49 ratchet, the current evidence-selected
