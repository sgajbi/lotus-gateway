...
| Future agent | What quality ceiling must not regress? | Agent quality evidence: `330/49`, current hotspot `src/app/clients/dpm_client.py` |
...
330/49 ratchet, the current evidence-selected
`src/app/clients/dpm_client.py` hotspot, and durable scorecard/context
