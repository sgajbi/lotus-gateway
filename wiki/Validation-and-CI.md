...
| Future agent | What quality ceiling must not regress? | Agent quality evidence: `325/49`, current hotspot `src/app/services/platform_capabilities_service.py` |
...
325/49 ratchet, the current evidence-selected
