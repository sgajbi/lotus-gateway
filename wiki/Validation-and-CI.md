...
| Future agent | What quality ceiling must not regress? | Agent quality evidence: `331/49`, current hotspot `src/app/contracts/domain_products.py` |
...
331/49 ratchet, the current evidence-selected
