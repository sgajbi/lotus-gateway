...
| Future agent | What quality ceiling must not regress? | Agent quality evidence: `321/49`, current hotspot `src/app/services/dpm_client_protocols.py` |
...
321/49 ratchet, the current evidence-selected
