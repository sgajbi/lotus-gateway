...
- duplicate fingerprints include Python-version-independent normalized AST context and stable
  occurrence ordering so line shifts or empty runtime-only AST fields do not invalidate unrelated
  clones, while replacements and non-empty type-parameter semantics remain visible
