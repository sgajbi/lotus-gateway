...
| Future agent | What quality ceiling must not regress? | Agent quality evidence: `319/49`, current hotspot `src/app/contracts/portfolio_workspace.py` |
...
319/49 ratchet, the current evidence-selected
