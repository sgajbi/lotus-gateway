...
| Future agent | What quality ceiling must not regress? | Agent quality evidence: `334/49`, current hotspot `src/app/services/foundation_core_snapshot.py` |
...
334/49 ratchet, the current evidence-selected
