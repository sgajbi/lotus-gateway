...
| Future agent | What quality ceiling must not regress? | Agent quality evidence: `326/49`, current hotspot `src/app/contracts/platform_capabilities.py` |
...
326/49 ratchet, the current evidence-selected
